...
@Config
@Autonomous(group = "right", name = "auto-stanga", preselectTeleOp = "Homosapiens TeleOP FSM")
public class StangaIncercare extends LinearOpMode {
...
//    double cy = 221.506;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence Puncte_multe = drive.trajectorySequenceBuilder(start)
                ...
                .lineToLinearHeading(new Pose2d(-28, -4, Math.toRadians(41)),
                        SampleMecanumDrive.getVelocityConstraint(40, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                ...
                .lineToLinearHeading(new Pose2d(-28, -4, Math.toRadians(48)),
